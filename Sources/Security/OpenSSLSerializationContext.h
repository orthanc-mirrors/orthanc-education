...
class OpenSSLSerializationContext : public boost::noncopyable
{
private:
  PointerRAII<BIO> bio_;

public:
  OpenSSLSerializationContext();

  BIO* GetValue()
  {
    return bio_.GetValue();
  }

  void Write(std::string& pem);
};
